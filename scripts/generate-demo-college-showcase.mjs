...
ins("DELETE FROM student_enrollments WHERE student_id GLOB 'stu_a0[2-6][1-9]' OR student_id GLOB 'stu_a0[3-6]0'");
ins("DELETE FROM student_entities WHERE id GLOB 'stu_a0[2-6][1-9]' OR id GLOB 'stu_a0[3-6]0'");
