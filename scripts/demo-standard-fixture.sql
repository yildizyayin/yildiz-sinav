...
('qb_demo_fen_07','PLATFORM',NULL,'2026-2027',7,'sub_fen','Canlılar','Hücre ve Bölünmeler','MULTIPLE_CHOICE',2,'Hücreyi dış ortamdan ayıran ve madde alışverişini düzenleyen yapı hangisidir?','["Hücre zarı","Çekirdek","Koful","Ribozom"]','A','Hücre zarı hücreyi çevreler ve seçici geçirgen yapısıyla madde alışverişini düzenler.','Sentetik Standard Demo','OWNED','APPROVED','usr_super','DEMO','usr_super',CURRENT_TIMESTAMP),
('qb_demo_fen_08','PLATFORM',NULL,'2026-2027',7,'sub_fen','Canlılar','Hücre ve Bölünmeler','MULTIPLE_CHOICE',3,'Büyüme ve yaraların onarılmasında görev alan hücre bölünmesi hangisidir?','["Mitoz","Mayoz","Döllenme","Tomurcuklanma"]','A','Çok hücreli canlılarda büyüme ve doku onarımı mitoz bölünme ile gerçekleşir.','Sentetik Standard Demo','OWNED','APPROVED','usr_super','DEMO','usr_super',CURRENT_TIMESTAMP);
