...
export function InstitutionPanelV2(){
 ...
 return <>
  ...
  <div className="action-grid">
   ...
   <Link className="quick-card" to="/bulk-operations"><div className="quick-icon"><Layers3/></div><div><h3>Toplu İşlemler</h3><p>Sınıflara toplu sınav katılımcısı, föy veya Nibiru Recovery aksiyonu uygulayın.</p></div></Link>
