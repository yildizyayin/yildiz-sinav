...
export function ExamCenter(){
  ...
  return <>
    ...
    {selected&&<div className="panel exam-operation-panel" style={{marginBottom:18}}>
      ...
      {!preview&&user?.role==='INSTITUTION_MANAGER'&&<div className="source-grid exam-upload-grid">
