...
export function ExamDefinitions() {
  ...
  const createExam = async (draftOnly = false) => {
    ...
    try {
      ...
      setNotice(documentFailures.length ? `Sınav oluşturuldu; bazı belgeler daha sonra tekrar yüklenmeli: ${documentFailures.join(' · ')}` : draftOnly
