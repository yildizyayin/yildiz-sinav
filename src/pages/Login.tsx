...
export function Login() {
  ...
  return <div className="login-page">
    ...
    <div className="login-panel"><form className="login-card" onSubmit={submit}>
      ...
      <label>Süper Admin doğrulama kodu <span className="muted">(yalnız yönetici hesabı)</span><input value={mfaCode} onChange={e=>setMfaCode(e.target.value.replace(/\D/g,'').slice(0,6))} inputMode="numeric" autoComplete="one-time-code" placeholder="6 haneli kod" maxLength={6}/></label>
