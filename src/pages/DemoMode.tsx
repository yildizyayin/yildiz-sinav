...
export function DemoMode(){
 ...
 return <>
  ...
  <div className="panel" style={{marginTop:20}}><div className="panel-head"><div><h2>Yeni demo kurumu</h2><p>Demo yalnız ANUNEX ölçme, optik, akademik analiz, föy ve Nibiru akışlarını göstermek içindir; ERP/ticari veri üretmez.</p></div><FlaskConical/></div>
   <div className="alert success"><ShieldCheck size={17}/><div><strong>Gerçek veriden izole</strong><br/><span>Oluşturulan kurum <code>demo_mode=1</code> olarak işaretlenir. Öğrenciler sentetiktir ve gerçek kurum kayıtlarından kopyalanmaz.</span></div></div>
   ...
   <p className="muted" style={{marginTop:10}}>Şifre en az 12 karakter olmalıdır. Ekranda sabit/ortak demo şifresi tutulmaz; her yeni demo için ayrı güçlü giriş üretilebilir.</p>
  </div>

  <div className="section-head"><div><h2>Demo kapsamı</h2><p>Sunum sırasında yalnız ölçme-değerlendirme ürününün uçtan uca akışlarını gösterin.</p></div></div>
  <div className="action-grid">
   ...
   <Link className="quick-card" to="/exam-center"><div className="quick-icon"><ClipboardCheck/></div><div><h3>Sınav Merkezi</h3><p>Sınav tanımı, kitapçık, katılımcı ve değerlendirme akışını gösterin.</p></div></Link>
   ...
   <Link className="quick-card" to="/nibiru"><div className="quick-icon"><BrainCircuit/></div><div><h3>Nibiru AI</h3><p>Ölçme verisinden rehberlik, öğrenme ve akademik gelişim desteğini gösterin.</p></div></Link>
