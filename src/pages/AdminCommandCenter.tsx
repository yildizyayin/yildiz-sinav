...
const modules: AdminModule[] = [
  ...
  { title: 'RBA & Rehberlik', subtitle: 'Ay · güvenli gelişim', description: 'Rehberlik testlerini, insan onayını ve gelişim sinyallerini yönetin.', state: 'CORE', color: 'moon', icon: <ShieldCheck />, to: '/guidance-admin', action: 'Test ve optik yönetimi aç' },
