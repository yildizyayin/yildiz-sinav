...
const modules: AdminModule[] = [
  { title: 'Sınav Merkezi', subtitle: 'Ölçme · operasyon akışı', description: 'Sınav ekle, yükle, optik/FMT bağla, puanla ve yayınla.', state: 'ACTIVE', color: 'measure', icon: <ClipboardCheck />, to: '/exam-center', action: 'Merkeze git' },
  { title: 'Soru Havuzu & Studio', subtitle: 'İçerik · soru zekâsı', description: 'Soru, şık, zorluk ve kazanım verisini tek kayıtta yönetin.', state: 'ACTIVE', color: 'content', icon: <Layers3 />, to: '/content-center', action: 'Havuzu aç' },
  ...
  { title: 'RBA & Rehberlik', subtitle: 'Rehberlik · güvenli gelişim', description: 'Rehberlik testlerini, insan onayını ve gelişim sinyallerini yönetin.', state: 'CORE', color: 'guidance', icon: <ShieldCheck />, to: '/nibiru-admin', action: 'Yönetimi aç' },
  ...
  { title: 'YouTube & Video', subtitle: 'Video · içerik bağlantısı', description: 'Video çözümünü soru, kazanım, test veya ödevle eşleştirin.', state: 'NEXT', color: 'video', icon: <PlayCircle />, to: '/content-center', action: 'İçerik merkezine git' },
  ...
  { title: 'Sonuç Ağı & Raporlar', subtitle: 'Raporlama · karşılaştırma halkaları', description: 'Kurum, sınıf, ilçe, il ve Türkiye sonuçlarını yönetin.', state: 'ACTIVE', color: 'reporting', icon: <BarChart3 />, to: '/reports', action: 'Raporları aç' },
];
  ...
  return <div className="admin-command-center">
    <section className="admin-command-hero">
      <div className="admin-command-hero-copy">
        <span className="eyebrow">ANUNEX · SÜPER ADMİN · YÖNETİM MERKEZİ</span>
      ...
      <div className="admin-command-nibiru" aria-label="Nibiru ortak akademik zekâ"><NibiruMark size={92} state="active" showWordmark/><small>{activeModules} modül aynı akışta</small></div>
    </section>
    ...
    <section className="admin-command-section-head"><div><span className="eyebrow">ANUNEX MODÜLLERİ</span><h2>Admin çalışma alanları</h2><p>Her modül kendi işini yapar; öğrenci, öğretmen ve veli panelleri aynı kaydı kullanır.</p></div></section>
