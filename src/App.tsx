...
export default function App(){
 ...
 return <Routes>
  ...
  <Route path="attendance" element={<RoleGate allowed={['SUPER_ADMIN','INSTITUTION_MANAGER','TEACHER','GUIDANCE_TEACHER']}><Attendance/></RoleGate>}/>
  <Route path="assignments" element={<RoleGate allowed={['SUPER_ADMIN','INSTITUTION_MANAGER','TEACHER','GUIDANCE_TEACHER','STUDENT']}><AssignmentCenter/></RoleGate>}/>
