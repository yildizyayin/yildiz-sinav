...
import { BarChart3, BookOpenCheck, Building2, CalendarRange, ClipboardCheck, FileUp, GraduationCap, Home, LogOut, Printer, ScanLine, ShieldCheck, Target, UserCog, Users, UserRoundCheck } from 'lucide-react';
...
const nav: Record<Role, Array<{ to: string; label: string; icon: any }>> = {
  SUPER_ADMIN: [
    ...
    { to: '/students', label: 'Öğrenciler', icon: Users }, { to: '/users', label: 'Kullanıcılar', icon: UserCog }, { to: '/teacher-assignments', label: 'Öğretmen Yetkileri', icon: ShieldCheck }, { to: '/seasons', label: 'Sezonlar', icon: CalendarRange },
  ...
  INSTITUTION_MANAGER: [
    ...
    { to: '/users', label: 'Kullanıcılar', icon: UserCog }, { to: '/teacher-assignments', label: 'Öğretmen Yetkileri', icon: ShieldCheck }, { to: '/seasons', label: 'Sezonlar', icon: CalendarRange }, { to: '/optical-prepare', label: 'Optik Hazırla', icon: Printer },
