...
import { BarChart3, Bell, BookMarked, BookOpenCheck, Bot, Building2, CalendarDays, CalendarRange, Camera, ClipboardCheck, Database, FileUp, FlaskConical, GraduationCap, Home, KeyRound, Layers3, ListChecks, LogOut, Megaphone, MessageCircle, Network, Printer, ScanLine, ShieldCheck, Target, UserCheck, UserCog, UserRound, Users, UserRoundCheck } from 'lucide-react';
import { useAuth, type Role } from '../auth';
import { LicenseBoundary } from './LicenseBoundary';

const nav: Record<Role, Array<{ to: string; label: string; icon: any }>> = {
  SUPER_ADMIN: [
    { to: '/', label: 'Ana Sayfa', icon: Home }, { to: '/nibiru', label: 'Nibiru AI', icon: Bot }, { to: '/nibiru-admin', label: 'Nibiru Yönetimi', icon: MessageCircle }, { to: '/licenses', label: 'Lisanslar', icon: KeyRound }, { to: '/academic-target-admin', label: 'Resmî Hedef Verileri', icon: Target }, { to: '/institutions', label: 'Kurumlar', icon: Building2 }, { to: '/networks', label: 'Zincir Kurumlar', icon: Network }, { to: '/curriculum', label: 'Müfredat & Kazanımlar', icon: BookMarked }, { to: '/exams', label: 'Sınav Merkezi', icon: ClipboardCheck }, { to: '/exam-definitions', label: 'Sınav Kataloğu', icon: Database },
  ...
  INSTITUTION_MANAGER: [
    { to: '/', label: 'Kurum Paneli', icon: Home }, { to: '/nibiru', label: 'Nibiru AI', icon: Bot }, { to: '/nibiru-admin', label: 'Nibiru Yönetimi', icon: MessageCircle }, { to: '/announcements', label: 'Duyuru Merkezi', icon: Megaphone }, { to: '/worksheet-calendar', label: 'Föy Takvimi', icon: CalendarDays }, { to: '/exams', label: 'Sınav Merkezi', icon: ClipboardCheck }, { to: '/exam-definitions', label: 'Kendi Sınavımı Oluştur', icon: Database }, { to: '/students', label: 'Öğrenciler', icon: Users },
  ...
  TEACHER: [
    { to: '/', label: 'Ana Sayfa', icon: Home }, { to: '/nibiru', label: 'Nibiru AI', icon: Bot }, { to: '/announcements', label: 'Duyurular', icon: Megaphone }, { to: '/worksheet-calendar', label: 'Föy Takvimi', icon: CalendarDays }, { to: '/classes', label: 'Sınıflarım', icon: GraduationCap }, { to: '/exams', label: 'Sınav Merkezi', icon: ClipboardCheck },
  ...
  STUDENT: [
    { to: '/', label: 'Ana Sayfa', icon: Home }, { to: '/nibiru', label: 'Nibiru AI', icon: Bot }, { to: '/academic-target', label: 'Hedefim', icon: Target }, { to: '/my-results', label: 'Sonuçlarım', icon: ClipboardCheck }, { to: '/wrong-answers', label: 'Yanlış / Boş Sorularım', icon: ListChecks }, { to: '/worksheets', label: 'Föylerim', icon: BookOpenCheck }, { to: '/notifications', label: 'Bildirimler', icon: Bell }, { to: '/profile', label: 'Profil', icon: UserRound },
  ],
  PARENT: [
