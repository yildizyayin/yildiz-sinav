...
export function AnunexSymbol({className=''}:{className?:string}){
  ...
  return <svg className={`anunex-symbol-canonical ${className}`.trim()} viewBox="0 0 72 72" role="img" aria-label="ANUNEX">
    <defs>
      <linearGradient id={`anunex-a-left-${id}`} x1="8" y1="62" x2="42" y2="5" gradientUnits="userSpaceOnUse"><stop stopColor="#72b7ff"/><stop offset=".52" stopColor="#2f70ee"/><stop offset="1" stopColor="#173eaa"/></linearGradient>
      <linearGradient id={`anunex-a-right-${id}`} x1="60" y1="61" x2="35" y2="10" gradientUnits="userSpaceOnUse"><stop stopColor="#081b52"/><stop offset=".48" stopColor="#0d317f"/><stop offset="1" stopColor="#1d59cf"/></linearGradient>
    </defs>
    <path d="M6 61 28.7 9.6C30.1 6.4 32.4 4.8 36 4.8h5.9L25.4 45.2l-5.9 15.8H6Z" fill={`url(#anunex-a-left-${id})`}/>
    <path d="M39.2 5.1 66 61H48.2L34.9 31.8l8.4-20.4-4.1-6.3Z" fill={`url(#anunex-a-right-${id})`}/>
