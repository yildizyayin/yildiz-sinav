...
describe('TXT/DAT/CSV parser detection',()=>{
 ...
 it('reads T.C. identity from delimited exports for first-priority matching',()=>{const text='tckn,student_number,name,answers_MAT\n10000000001,1001,Ahmet Yılmaz,ABCDE';const r=parseUploadedText(text,'sample.csv',[]);expect(r.records[0].tckn).toBe('10000000001')});
