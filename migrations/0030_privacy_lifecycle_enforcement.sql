...
VALUES
  ...
  ('ret_login_attempt','LOGIN_ATTEMPT_SECURITY','LOGIN_ATTEMPT','Limit security telemetry containing identifier/IP hashes.','CREATED_AT',90,'Technical template only; legal retention period requires counsel approval.','DELETE',1,'LEGAL_REVIEW'),
